...
# Rename totfatpvm
names(data)[names(data) == "totfatpvm"] <- "total_fatalities_per_100 mi"

# Rename nghtfatpvm
names(data)[names(data) == "nghtfatpvm"] <- "nighttime_fatalities_per_100 mi"

# Rename wkndfatpvm weekend fatalities per 100 mi
names(data)[names(data) == "wkndfatpvm"] <- "weekend_fatalities_per_100_mi"
