...
# Rename wkndfatpvm weekend fatalities per 100 mi
...
> 'Based on the data being state-derived, it is highly likely that the data originates from police accident reports. This means that the total_falities_rate variable is the total number of fatalities, as reported by police accident reports (i.e., the number of fatalities that occured as a part of roadway accident per year in each respective state.'
